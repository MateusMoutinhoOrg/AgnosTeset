...
Server is the http surface of the sandbox: every route the project declares, and the dispatch that reads a request against them. It is built by sandbox/internal/server/server/new.go, generated by `agnos build`.
