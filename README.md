...
| Doc | Description |
| --- | --- |
| [CliInstall](docs/CliInstall/doc.md) | Install Url-Shortner: a released binary per platform, or a build from source |
| [Commands](docs/Commands/doc.md) | Every command of Url-Shortner, generated from the command declarations |
| [CliExamples](docs/CliExamples/doc.md) | Index of every runnable example of the Url-Shortner cli |
...
| Doc | Description |
| --- | --- |
| [ServerUsage](docs/ServerUsage/doc.md) | Serve http from Url-Shortner: bring the layer up, declare routes, read a body |
| [FrontUsage](docs/FrontUsage/doc.md) | Serve html from Url-Shortner: bring the front layer up, declare pages, link assets |
| [Routes](docs/Routes/doc.md) | Every route of Url-Shortner, generated from the route declarations |
...
| Doc | Description |
| --- | --- |
| [LibUsage](docs/LibUsage/doc.md) | Use Url-Shortner as a Go module: wire the deps, build the sandbox, call its API |
| [PublicApi](docs/PublicApi/doc.md) | Every exported symbol of Url-Shortner, generated from the contract sources and their doc comments |
| [LibExamples](docs/LibExamples/doc.md) | Index of every runnable example of Url-Shortner as a Go module |
