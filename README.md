...
| Doc | Description |
| --- | --- |
| [CliInstall](docs/CliInstall/doc.md) | Install NewRoutes: a released binary per platform, or a build from source |
| [Commands](docs/Commands/doc.md) | Every command of NewRoutes, generated from the command declarations |
| [CliExamples](docs/CliExamples/doc.md) | Index of every runnable example of the NewRoutes cli |
...
| Doc | Description |
| --- | --- |
| [ServerUsage](docs/ServerUsage/doc.md) | Serve http from NewRoutes: bring the layer up, declare routes, read a body |
| [Routes](docs/Routes/doc.md) | Every route of NewRoutes, generated from the route declarations |
