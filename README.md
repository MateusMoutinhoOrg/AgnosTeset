...
| Doc | Description |
| --- | --- |
| [CliInstall](docs/CliInstall/doc.md) | Install FinanceApp: a released binary per platform, or a build from source |
| [Commands](docs/Commands/doc.md) | Every command of FinanceApp, generated from the command declarations |
| [CliExamples](docs/CliExamples/doc.md) | Index of every runnable example of the FinanceApp cli |
...
| Doc | Description |
| --- | --- |
| [ServerUsage](docs/ServerUsage/doc.md) | Serve http from FinanceApp: bring the layer up, declare routes, read a body |
| [FrontUsage](docs/FrontUsage/doc.md) | Serve html from FinanceApp: bring the front layer up, declare pages, link assets |
| [Routes](docs/Routes/doc.md) | Every route of FinanceApp, generated from the route declarations |
...
| Doc | Description |
| --- | --- |
| [LibUsage](docs/LibUsage/doc.md) | Use FinanceApp as a Go module: wire the deps, build the sandbox, call its API |
| [PublicApi](docs/PublicApi/doc.md) | Every exported symbol of FinanceApp, generated from the contract sources and their doc comments |
| [LibExamples](docs/LibExamples/doc.md) | Index of every runnable example of FinanceApp as a Go module |
...
| Doc | Description |
| --- | --- |
| [Databases](docs/Databases/doc.md) | Every database of FinanceApp, generated from the table declarations |
